...
export const FormDespacho = ({ venta, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log("API DESPACHOS:", import.meta.env.VITE_API_DESPACHOS);
      console.log("URL:", `${import.meta.env.VITE_API_DESPACHOS}/${despacho.idDespacho}`);
      await axios.put(
        `${import.meta.env.VITE_API_VENTAS}/${venta.idVenta}`,
        jsonDataSales,
        {
          headers:{
      ...
      await axios.post(import.meta.env.VITE_API_DESPACHOS, jsonData, {
        headers:{
          'Content-Type': 'application/json',
          'Accept': 'application/json'
    }
